 ...
 * Downloads.js
 *
 * Simple Downloads page component that shows documents in a tile layout.
 * - Add files to /public/docs/ (or your static assets folder) and update the `href` values below.
 *
 * Usage:
 *  - Place this file in your pages or components folder (depending on your site layout).
 *  - Ensure the PDF/image files are served from the paths used in the `documents` array (or update them).
 */
...
const documents = [
  ...
  },
  {
    ...
    description:
      "Course codes and diagrams for club racing. Quick reference for course selection by wind direction and shortened-course options. (Image / printable)",
    ...
    <main style={styles.page}>
      <header style={styles.header}>
        ...
        <p style={styles.subtitle}>
          Download event documents, sailing instructions and quick-reference course sheets. Files will open in a new tab and can be saved locally.
        </p>
      </header>
          ...
          <article key={doc.id} style={styles.tile}>
            <div>
              <div style={styles.tileHeader}>
                <div style={styles.fileIcon} aria-hidden>
            ...
            <div style={styles.actions}>
              {/* Download link (forces save in many browsers) */}
              <a
                style={styles.button}
                href={doc.href}
